    ...
    CodeBlock.prototype = {
        ...
        run: function() {
            ...
            if(currRunCodeType == "js"){
                ...
                evalCode(currRunCodeType, this.editor.getValue(), function(returnValResult){manageConsoleVal(returnValResult, pthis, false)}, function(msg){console.error("ERROR return:-->", msg)});
            }
