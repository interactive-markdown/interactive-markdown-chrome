...
;(function ( $, window, document, undefined ) {
    ...
    CodeBlock.prototype = {
        ...
        run: function() {
            ...
            if (!$.isEmptyObject(codeStringDict)) {
                ...
                this.editor.setValue( addedEditorVal + originalEditorVal );
                console.debug("added + original EditorVal:--> ", addedEditorVal + originalEditorVal);

                //#ORIGINAL
                this.base.add(this.original).trigger("codeblock.run");

                var val = addedEditorVal;
