        ...
        run: function() {
            ...
            if(currRunCodeType == "js"){
                ...
                if (typeof htmlIframeRet == "undefined"){ //#QUICK-HACK
                    ...
                    ifrmRet.idoc.getElementsByTagName("html")[0].innerHTML = currRunCodeText;
                    ifrmRet.ifrm.id = "html-iframe-demo";
                    ifrmRet.ifrm.width = 700;
                    ifrmRet.ifrm.height = 1500;
                    htmlIframeRet = ifrmRet;
                }
                else{ //#QUICK-HACK
                    currRunCodeText = this.editor.getValue();
                    htmlIframeRet.idoc.getElementsByTagName("html")[0].innerHTML = currRunCodeText;
                }
            }
            else{
